...
Telemetria completa exportada via **OTLP** diretamente para Grafana Cloud (`REDACTED_GRAFANA_ENDPOINT`):
...
- Stack: `REDACTED_GRAFANA_ENDPOINT`
...
| Grafana Cloud | https://REDACTED_GRAFANA_ENDPOINT |
