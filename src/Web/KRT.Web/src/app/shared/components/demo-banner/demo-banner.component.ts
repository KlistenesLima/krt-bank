    ...
    <div class="portfolio-banner" [class.visible]="visible">
      <div class="banner-inner">
        <div class="banner-text">
          <span class="banner-icon" innerHTML='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="16" height="16"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22V6h6v16"/><path d="M4 6h16"/></svg>'></span>
          <span class="banner-prefix">Case de Portfólio — </span>
...
export class DemoBannerComponent implements OnInit {
  ...
  links: BannerLink[] = [
    {
      href: 'https://linkedin.com/in/klisteneslima',
      label: 'LinkedIn',
      external: true,
