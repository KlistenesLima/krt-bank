...
@Component({
      ...
      <div class="banner-content">
        ...
        <div class="banner-links">
          <a *ngFor="let link of links"
            ...
            <span class="link-tooltip">{{ link.label }}</span>
          </a>
        </div>
      </div>
  ...
  styles: [`
    ...
    .banner-link:hover {
      ...
      filter: drop-shadow(0 0 6px rgba(0, 71, 187, 0.5));
    }
    .link-icon {
      display: flex;
      align-items: center;
    ...
    .banner-link:hover .link-tooltip {
      opacity: 1;
    }
    .banner-border {
      height: 1px;
...
export class DemoBannerComponent implements OnInit {
  ...
  links: BannerLink[] = [
    ...
    },
    {
      ...
      label: 'Currículo',
      external: false,
      icon: '<svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>'
    }
  ];
