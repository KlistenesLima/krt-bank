...
@Component({
  ...
  styles: [`
    ...
    .auth-card { 
      background: white; /* GARANTIR FUNDO BRANCO */
    ...
    .full-width-btn { width: 100%; margin-top: 10px; height: 50px; font-size: 1rem; }
    .custom-field { width: 100%; margin-bottom: 15px; }
...
export class LoginComponent {
  ...
  login() {
    ...
    if (id) this.router.navigate(['/dashboard']);
        ...
        alert('Para testar, crie uma conta nova!');
